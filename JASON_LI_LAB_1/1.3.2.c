...
/* because compare value funtions don't incorporate system clock prescaler, this code will run much slowere than that of 1.3.1
*/
...
int main(void)
{
	_clockdivide(4); //set the clock speed to 16Mhz/4
